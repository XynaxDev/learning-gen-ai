...
class ReviewComplex(TypedDict):
    key_features:Annotated[list[str], "Write down all the key features mentioned in the review"]
    summary: Annotated[str, "A brief summary of the review!"]
    sentiment: Annotated[Literal["pos","neg"], "Return sentiment of the review either negative, positive or neutral"] # Literal used for exact outputs
